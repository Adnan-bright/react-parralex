          ...
          <div className={style.mblBody}>
            <div className={style.midContainer}>
              <div className={style.mblHeadingsContainer}>
                ...
                <p className={style.mblMidHeading}>{titleText?.secondLine}</p>
                <p className={style.mblBtmHeading}>{titleText?.thirdLine}</p>
              </div>
              <center>
                <img
            ...
            <div className={style.mblScrollTxtCont}>
              <p className={style.mblScrollText}>Scroll</p>
              <center>
                <img
                  className={style.mblDownArrow}
                  src="/images/home/downArrow.webp"
                />
              </center>
            </div>
          </div>
        ...
        <div>
          ...
          <div className={`${style.main} `}>
            ...
            >
              <div
                className={
                  video ? style.bgImgContainerHide : style.bgImgContainer
                }
              >
                <ReactPlayer
                  playing={true}
            ...
            <div
              className={`${
                video ? style.contentHide : style.content
              } hero1MainContent`}
            >
              <div className={style.headings}>
                <div className={`${style.mainHeading1}`}>
                  {titleText?.firstLine}
                </div>
                ...
                <div className={style.mainHeading3}>{titleText?.thirdLine}</div>
              </div>
              <div style={{}} className={style.playIconContainer}>
                <img
