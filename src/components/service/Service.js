  ...
  return (
    <div>
      {isMobile ? (
        <div className={`${style.mblMain}  `}>
          ...
          >
            <div className={style.mblVideoContainer}>
              <div className={style.mblVideoBox}>
                {!loading && (
                  <img
                    onClick={() => {
                      setLoading(true);
            ...
            <div>
              ...
              <div className={style.mblImagesContainer}>
                {items.map((item, index) => {
                  return (
                    <center key={index}>
                      <div className={`${style.mblImgCont}`}>
                        <img
                          className={style.mblImgItem}
                          src={
                            index === 0
                              ? filmData.bgImage
                              : index === 1
        ...
        <div className={`${style.main}  serviceMainSection`}>
          <div
            style={{
              display: video ? "flex" : "none",
            }}
          ...
          <div>
            <div>
              <div
                className={
                  video ? style.contentInVisible : style.contentVisible
                }
              >
                <div>
                    ...
                    <div className="serviceCard1">
                      <div
                        ...
                        className={`${
                          whichCard === "film"
                            ? style.newStyle
                            : whichCard === "design" || whichCard === "tech"
                            ? style.newStyle1
                            : style.newStyle2
                        } 
                                                            ${style.imgCont}`}
                      >
                        <img className={style.imgItem} src={filmData.bgImage} />
                    ...
                    <div>
                      <div
                        ...
                        className={`${
                          whichCard === "design"
                            ? style.newStyle
                            : whichCard === "film" || whichCard === "tech"
                            ? style.newStyle1
                            : style.newStyle2
                        } ${style.imgCont} serviceCard2`}
                      >
                        <img
                          className={style.imgItem}
                          src={designData.bgImage}
                        />
                        <h2 className={`${style.imgText} serviceDesignText`}>
                          Design
                        </h2>
                        <p className={style.imglowerText}>
                    ...
                    <div>
                      <div
                        ...
                        className={`${
                          whichCard === "tech"
                            ? style.newStyle
                            : whichCard === "film" || whichCard === "design"
                            ? style.newStyle1
                            : style.newStyle2
                        } 
                                                 ${style.imgCont} serviceCard3`}
                      >
                        <img className={style.imgItem} src={techData.bgImage} />
