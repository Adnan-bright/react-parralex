...
function UseService() {
    ...
    const {designDescription, designVideo, designVideoUrl, backgroundImage} = design
    const designData = {
    ...
    const {filmDescription, filmVideo, filmVideoUrl, backgroundImage:filmBackgroundImage} = film
    const filmData = {
    ...
    const {techDescription, techVideo, techVideoUrl, backgroundImage:techBackgroundImage} = tech
    const techData = {
